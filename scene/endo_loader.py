...
class EndoNeRF_Dataset(object):
    ...
    def load_meta(self):
        ...
        agg_png = lambda filetype: sorted(glob.glob(os.path.join(self.root_dir, filetype, "*.png")))
        agg_npy = lambda filetype: sorted(glob.glob(os.path.join(self.root_dir, filetype, "*.npy")))
        self.image_paths = agg_png("images")
